...
object RetrofitInstance {
    ...
    val RETROFIT = Retrofit.Builder().baseUrl(Define.BASE_URL_HTTP).client(okHttpClient).addConverterFactory(GsonConverterFactory.create()).build() // BASE_URL에 접근하기 위한 변수
    ...
    val SERVER_HTTPS = retrofit.create(RetrofitService::class.java)!!
}